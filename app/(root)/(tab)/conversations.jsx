...
import { SentryFeedbackFAB } from "../../../components/SentryFeedback";
    ...
    return (
      ...
      >
        <View style={styles.avatarWrapper}>
          <Avatar uri={otherUser?.image} size={56} />
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.8}
      >
        <Feather name="edit-3" size={24} color={theme.surface} />
      </TouchableOpacity>
      <SentryFeedbackFAB position="bottom-left" />
      {/* Conversations List */}
      {isLoading ? (
